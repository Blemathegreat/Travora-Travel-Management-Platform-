...
export default function Partnership() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] py-10 px-4 sm:px-6 lg:px-12">
      <div className="mx-auto flex w-full max-w-[1360px] flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
